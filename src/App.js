  ...
  render(){
    return (
      <div >
        ...
        <Route exact path="/sign-in" component={() => <SignIn signIn={this.signIn}/>}/>
        <Route exact path="/sign-up" component={() => <SignUp signIn={this.signIn}/>}/>
        {/* <Route exact path="/sign-up" component={() => <SignUp signUp={this.signUp}/>}/> */}
